...
CREATE TABLE IF NOT EXISTS `common_code` (
  `common_code_no` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '공통코드 번호',
  ...
  PRIMARY KEY (`common_code_no`) USING BTREE,
...
CREATE TABLE IF NOT EXISTS `term` (
  ...
  `display_date` date DEFAULT NULL COMMENT '전시일자',
...
CREATE TABLE IF NOT EXISTS `user_term_agree_history` (
  ...
  `agree_datetime` date DEFAULT NULL COMMENT '동의일시',
